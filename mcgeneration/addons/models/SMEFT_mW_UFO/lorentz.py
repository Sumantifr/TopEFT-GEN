...
FFFF9 = Lorentz(name = 'FFFF9',
                spins = [ 2, 2, 2, 2 ],
                structure = 'Gamma(-2,-5,-4)*Gamma(-2,-3,-6)*Gamma(-1,2,-3)*Gamma(-1,4,-5)*ProjM(-6,1)*ProjM(-4,3)')
...
FFFF24 = Lorentz(name = 'FFFF24',
                 spins = [ 2, 2, 2, 2 ],
                 structure = 'Gamma(-2,-3,-6)*Gamma(-2,4,-5)*Gamma(-1,-5,-4)*Gamma(-1,2,-3)*ProjP(-6,1)*ProjP(-4,3)')

FFFF25 = Lorentz(name = 'FFFF25',
                 spins = [ 2, 2, 2, 2 ],
                 structure = 'Gamma(-2,-5,-4)*Gamma(-2,2,-3)*Gamma(-1,-3,-6)*Gamma(-1,4,-5)*ProjP(-6,1)*ProjP(-4,3)')
...
FFVS10 = Lorentz(name = 'FFVS10',
                 spins = [ 2, 2, 3, 1 ],
                 structure = 'P(-1,3)*Gamma(-1,2,-2)*Gamma(3,-2,-3)*ProjP(-3,1)')
...
VVVV3 = Lorentz(name = 'VVVV3',
                spins = [ 3, 3, 3, 3 ],
                structure = '2*Epsilon(1,2,3,4)*P(-1,2)*P(-1,3) + 2*Epsilon(1,2,3,4)*P(-1,1)*P(-1,4) - 2*Epsilon(2,3,4,-1)*P(-1,3)*P(1,2) - 2*Epsilon(2,3,4,-1)*P(-1,2)*P(1,3) + 2*Epsilon(2,3,4,-1)*P(-1,1)*P(1,4) + 2*Epsilon(1,3,4,-1)*P(-1,4)*P(2,1) - 2*Epsilon(1,3,4,-1)*P(-1,2)*P(2,3) + 2*Epsilon(1,3,4,-1)*P(-1,1)*P(2,4) - 2*Epsilon(1,2,4,-1)*P(-1,4)*P(3,1) + 2*Epsilon(1,2,4,-1)*P(-1,3)*P(3,2) - 2*Epsilon(1,2,4,-1)*P(-1,1)*P(3,4) - 2*Epsilon(1,2,3,-1)*P(-1,4)*P(4,1) + 2*Epsilon(1,2,3,-1)*P(-1,3)*P(4,2) + 2*Epsilon(1,2,3,-1)*P(-1,2)*P(4,3) - 2*Epsilon(3,4,-1,-2)*P(-2,4)*P(-1,1)*Metric(1,2) + 2*Epsilon(3,4,-1,-2)*P(-2,3)*P(-1,2)*Metric(1,2) + 2*Epsilon(2,4,-1,-2)*P(-2,4)*P(-1,1)*Metric(1,3) - 2*Epsilon(2,4,-1,-2)*P(-2,2)*P(-1,3)*Metric(1,3) + Epsilon(2,3,-1,-2)*P(-2,4)*P(-1,1)*Metric(1,4) - Epsilon(2,3,-1,-2)*P(-2,1)*P(-1,4)*Metric(1,4) + Epsilon(1,4,-1,-2)*P(-2,3)*P(-1,2)*Metric(2,3) - Epsilon(1,4,-1,-2)*P(-2,2)*P(-1,3)*Metric(2,3) + 2*Epsilon(1,3,-1,-2)*P(-2,3)*P(-1,2)*Metric(2,4) - 2*Epsilon(1,3,-1,-2)*P(-2,1)*P(-1,4)*Metric(2,4) - 2*Epsilon(1,2,-1,-2)*P(-2,2)*P(-1,3)*Metric(3,4) + 2*Epsilon(1,2,-1,-2)*P(-2,1)*P(-1,4)*Metric(3,4)')

VVVV4 = Lorentz(name = 'VVVV4',
                spins = [ 3, 3, 3, 3 ],
                structure = '-2*Epsilon(1,2,3,4)*P(-1,1)*P(-1,3) - 2*Epsilon(1,2,3,4)*P(-1,2)*P(-1,4) + 2*Epsilon(2,3,4,-1)*P(-1,4)*P(1,2) - 2*Epsilon(2,3,4,-1)*P(-1,1)*P(1,3) + 2*Epsilon(2,3,4,-1)*P(-1,2)*P(1,4) - 2*Epsilon(1,3,4,-1)*P(-1,3)*P(2,1) - 2*Epsilon(1,3,4,-1)*P(-1,1)*P(2,3) + 2*Epsilon(1,3,4,-1)*P(-1,2)*P(2,4) - 2*Epsilon(1,2,4,-1)*P(-1,3)*P(3,1) + 2*Epsilon(1,2,4,-1)*P(-1,4)*P(3,2) + 2*Epsilon(1,2,4,-1)*P(-1,2)*P(3,4) - 2*Epsilon(1,2,3,-1)*P(-1,3)*P(4,1) + 2*Epsilon(1,2,3,-1)*P(-1,4)*P(4,2) - 2*Epsilon(1,2,3,-1)*P(-1,1)*P(4,3) + 2*Epsilon(3,4,-1,-2)*P(-2,3)*P(-1,1)*Metric(1,2) - 2*Epsilon(3,4,-1,-2)*P(-2,4)*P(-1,2)*Metric(1,2) + Epsilon(2,4,-1,-2)*P(-2,3)*P(-1,1)*Metric(1,3) - Epsilon(2,4,-1,-2)*P(-2,1)*P(-1,3)*Metric(1,3) + 2*Epsilon(2,3,-1,-2)*P(-2,3)*P(-1,1)*Metric(1,4) - 2*Epsilon(2,3,-1,-2)*P(-2,2)*P(-1,4)*Metric(1,4) + 2*Epsilon(1,4,-1,-2)*P(-2,4)*P(-1,2)*Metric(2,3) - 2*Epsilon(1,4,-1,-2)*P(-2,1)*P(-1,3)*Metric(2,3) + Epsilon(1,3,-1,-2)*P(-2,4)*P(-1,2)*Metric(2,4) - Epsilon(1,3,-1,-2)*P(-2,2)*P(-1,4)*Metric(2,4) + 2*Epsilon(1,2,-1,-2)*P(-2,1)*P(-1,3)*Metric(3,4) - 2*Epsilon(1,2,-1,-2)*P(-2,2)*P(-1,4)*Metric(3,4)')
...
VVVV6 = Lorentz(name = 'VVVV6',
                spins = [ 3, 3, 3, 3 ],
                structure = 'Epsilon(1,2,3,4)*P(-1,1)*P(-1,2) + Epsilon(1,2,3,4)*P(-1,3)*P(-1,4) + Epsilon(2,3,4,-1)*P(-1,1)*P(1,2) - Epsilon(2,3,4,-1)*P(-1,4)*P(1,3) - Epsilon(2,3,4,-1)*P(-1,3)*P(1,4) - Epsilon(1,3,4,-1)*P(-1,2)*P(2,1) + Epsilon(1,3,4,-1)*P(-1,4)*P(2,3) + Epsilon(1,3,4,-1)*P(-1,3)*P(2,4) - Epsilon(1,2,4,-1)*P(-1,2)*P(3,1) - Epsilon(1,2,4,-1)*P(-1,1)*P(3,2) + Epsilon(1,2,4,-1)*P(-1,3)*P(3,4) + Epsilon(1,2,3,-1)*P(-1,2)*P(4,1) + Epsilon(1,2,3,-1)*P(-1,1)*P(4,2) - Epsilon(1,2,3,-1)*P(-1,4)*P(4,3) + (Epsilon(3,4,-1,-2)*P(-2,2)*P(-1,1)*Metric(1,2))/2. - (Epsilon(3,4,-1,-2)*P(-2,1)*P(-1,2)*Metric(1,2))/2. + Epsilon(2,4,-1,-2)*P(-2,2)*P(-1,1)*Metric(1,3) - Epsilon(2,4,-1,-2)*P(-2,4)*P(-1,3)*Metric(1,3) - Epsilon(2,3,-1,-2)*P(-2,2)*P(-1,1)*Metric(1,4) + Epsilon(2,3,-1,-2)*P(-2,3)*P(-1,4)*Metric(1,4) - Epsilon(1,4,-1,-2)*P(-2,1)*P(-1,2)*Metric(2,3) + Epsilon(1,4,-1,-2)*P(-2,4)*P(-1,3)*Metric(2,3) + Epsilon(1,3,-1,-2)*P(-2,1)*P(-1,2)*Metric(2,4) - Epsilon(1,3,-1,-2)*P(-2,3)*P(-1,4)*Metric(2,4) + (Epsilon(1,2,-1,-2)*P(-2,4)*P(-1,3)*Metric(3,4))/2. - (Epsilon(1,2,-1,-2)*P(-2,3)*P(-1,4)*Metric(3,4))/2.')
